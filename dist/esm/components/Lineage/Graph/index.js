...
import { HappiGraph, HappiGraphActions } from 'happi-graph';
...
export function EgeriaLineageGraph(props) {
    ...
    return (_jsx("div", Object.assign({ className: "egeria-lineage" }, { children: _jsxs(Tabs, Object.assign({ grow: true, style: { height: '100%', position: 'relative' }, initialTab: getIndexOfLineage(lineageType), active: getIndexOfLineage(lineageType), onTabChange: (value) => onTabChange(value) }, { children: [_jsxs(Tabs.Tab, Object.assign({ label: LINEAGE.END_TO_END }, { children: [loading && _jsx(LoadingOverlay, { visible: true }), !loading && _jsx(HappiGraph, { rawData: Object.assign({}, rawData), algorithm: "VISJS", debug: false, graphDirection: "HORIZONTAL", selectedNodeId: guid, actions: _jsx(HappiGraphActions, { rawData: Object.assign({}, rawData) }) })] })), _jsxs(Tabs.Tab, Object.assign({ label: LINEAGE.VERTICAL_LINEAGE }, { children: [loading && _jsx(LoadingOverlay, { visible: true }), !loading && _jsx(HappiGraph, { rawData: Object.assign({}, rawData), algorithm: "ELK", debug: false, graphDirection: "VERTICAL", selectedNodeId: guid, actions: _jsx(HappiGraphActions, { rawData: Object.assign({}, rawData) }) })] })), _jsxs(Tabs.Tab, Object.assign({ label: LINEAGE.ULTIMATE_SOURCE }, { children: [loading && _jsx(LoadingOverlay, { visible: true }), !loading && _jsx(HappiGraph, { rawData: Object.assign({}, rawData), algorithm: "VISJS", debug: false, graphDirection: "HORIZONTAL", selectedNodeId: guid, actions: _jsx(HappiGraphActions, { rawData: Object.assign({}, rawData) }) })] })), _jsxs(Tabs.Tab, Object.assign({ label: LINEAGE.ULTIMATE_DESTINATION }, { children: [loading && _jsx(LoadingOverlay, { visible: true }), !loading && _jsx(HappiGraph, { rawData: Object.assign({}, rawData), algorithm: "VISJS", debug: false, graphDirection: "HORIZONTAL", selectedNodeId: guid, actions: _jsx(HappiGraphActions, { rawData: Object.assign({}, rawData) }) })] }))] })) })));
}
